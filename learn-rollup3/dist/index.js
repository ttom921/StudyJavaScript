  ...
  function () {
    ...
    _createClass(RxjsWrapper, [{
      ...
      value: function get(url, headers) {
        return ajax.getJSON(url, headers); // const subscribe = users.subscribe(
        //     res => console.log(res),
  ...
  function () {
    ...
    _createClass(Engine, [{
      ...
      value: function getAjaxTest() {
        ...
        //     url: 'http://64.141.182.94:80/v0.4',
        //     crossDomain: true,
        //     body: {},
        //     responseType: 'json',
        // }
        ...
        var rxajax = new RxjsWrapper(); // rxajax.get(url, headers).subscribe(
        //     data => {
        ...
        var asadata$ = rxajax.get("http://64.141.182.94:80/v0.4/servers", headers);
        asadata$.subscribe(function (data) {
          console.log(data);
        });
      }
    }], [{
